...
### Project 1
## [From Stray to Stay: Predicting Adoption for Shelter Cats](https://github.com/sun712k/animal-shelter.git){:target="_blank"}
[<img src="/assets/img/mellow_shelter.jpg" alt="Image" width="500" >](https://github.com/sun712k/animal-shelter.git){:target="_blank"}
...
### Project 2
## [Integrated Health Assessment: Predicting Heart Disease and Diabetes with CDC Data(ft.streamlit)](https://github.com/sun712k/chronic-disease.git){:target="_blank"}
[<img src="/assets/img/disease-image.jpeg" alt="Image" width="500" >](https://github.com/sun712k/chronic-disease.git){:target="_blank"}
...
### Project 3
## [Purrfect Cat Image Recognition: Classification for My Cat and other Cats](https://github.com/sun712k/cat-image-recognition.git){:target="_blank"}
[<img src="/assets/img/mellow face_recognized.jpg" alt="Image" width="500">](https://github.com/sun712k/cat-image-recognition.git){:target="_blank"}
...
### Project 4
## [Cat Vocalizations Clustering: Exploring the Diversity of Cat Meows](https://github.com/sun712k/cat-vocalization-clustering.git){:target="_blank"}
[<img src="/assets/img/mellow_meowing.jpg" alt="Image" width="500">](https://github.com/sun712k/cat-vocalization-clustering.git){:target="_blank"}
...
[<img src="/assets/img/marathon.jpg" alt="Image" width="500">](https://github.com/sun712k/Altitude-and-Marathon){:target="_blank"}
